...
// Call Utilities to get the animal name lists
        ...
        AnimalNameListsWrapper animalLists = shruti.zoo.com.Utilities.createAnimalNameLists(filePath);
...
// Pop a name from the list of hyena names
   ...
   // calculate birthdate
   String birthDate = shruti.zoo.com.Utilities.calcAnimalBirthDate( Integer.parseInt(ageInYears) , animalBirthSeason) ;
// Create a hyena object and attach to the hyena ArrayList;
                    Hyena hyena = new Hyena(aniSex, intAniAge, 99, myName,
                            aniID, birthDate, aniColor,
